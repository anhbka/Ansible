...
function neutron_config() {		
    ...
    ctl_metadata_agent=/etc/neutron/metadata_agent.ini
        ...
        ops_edit $ctl_neutron_conf linux_bridge physical_interface_mappings provider:eth0
        ...
        ops_edit $ctl_linuxbridge_agent linux_bridge physical_interface_mappings provider:eth0
